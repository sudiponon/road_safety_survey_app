...
class QuestionThirtyTwo extends StatefulWidget {

  @override
  _QuestionThirtyTwoState createState() => _QuestionThirtyTwoState();
}

class _QuestionThirtyTwoState extends State<QuestionThirtyTwo> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            myRadioButton(
                title: text_qsn32a,
                value: 0,
                groupValue: controller.groupValue32,
                onChanged: controller.ans32),
            myRadioButton(
                title: text_qsn32b,
                value: 1,
                groupValue: controller.groupValue32,
