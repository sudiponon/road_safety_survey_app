...
class QuestionThirtyFive extends StatefulWidget {

  @override
  _QuestionThirtyFiveState createState() => _QuestionThirtyFiveState();
}

class _QuestionThirtyFiveState extends State<QuestionThirtyFive> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            _myRadioButton(
                title: text_qsn35a,
                value: 0,
                groupValue: controller.groupValue35,
                onChanged: controller.ans35),
            _myRadioButton(
                title: text_qsn35b,
                groupValue: controller.groupValue35,
                value: 1,
            ...
            _myRadioButton(
                ...
                value: 4,
                onChanged: controller.ans35),
            controller.groupValue35 == 4
                ? Padding(
              padding: const EdgeInsets.only(left: 40.0, right: 20, bottom: 10),
              child: AppTextFormField(
                labelText: "Specify",
                controllerText: controller.qsn35Controller,
