...
class QuestionTwentySix extends StatefulWidget {

  @override
  _QuestionTwentySixState createState() => _QuestionTwentySixState();
}

class _QuestionTwentySixState extends State<QuestionTwentySix> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            myRadioButton(
                title: text_qsn26a,
                value: 0,
                groupValue: controller.groupValue26,
                onChanged: controller.ans26),
            myRadioButton(
                title: text_qsn26b,
                groupValue: controller.groupValue26,
                value: 1,
            ...
            myRadioButton(
                ...
                value: 3,
                onChanged: controller.ans26),
            controller.groupValue26 == 3
                ? Padding(
              padding: const EdgeInsets.only(left: 40.0, right: 20),
              child: AppTextFormField(
                labelText: "Specify",
                controllerText: controller.qsn26Controller,
