...
class QuestionSeventeen extends StatefulWidget {

  @override
  _QuestionSeventeenState createState() => _QuestionSeventeenState();
}

class _QuestionSeventeenState extends State<QuestionSeventeen> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            myRadioButton(
                title: text_qsn17a,
                value: 0,
                groupValue: controller.groupValue17,
                onChanged: controller.ans17),
            myRadioButton(
                title: text_qsn17b,
                value: 1,
                groupValue: controller.groupValue17,
